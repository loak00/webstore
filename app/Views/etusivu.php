            ...
            <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid shadow" src="<?= base_url('img/promo1sm.jpg') ?>" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid shadow" src="<?= base_url('img/promo2sm.jpg') ?>" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block img-fluid shadow" src="<?= base_url('img/promo3sm.jpg') ?>" alt="Third slide">
                    </div>
                </div>
